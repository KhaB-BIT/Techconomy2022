<header>
    <div class="navigation">
        ...
        <nav id="nav-mobile">
            ...
            <a class="nav__link" href="#intro">Giới thiệu
                <div class="before"></div>
            </a>
            <a class="nav__link" href="#round">Về cuộc thi
                <div class="before"></div>
            </a>
            <a class="nav__link" href="#partner">Đối tác
                <div class="before"></div>
            </a>
            <a class="nav__link" href="">FAQs
                <div class="before"></div>
            </a>
            <a class="nav__link" href="#footer">Liên hệ
                <div class="before"></div>
            </a>
        </nav>
    ...
    <div class="banner">
        ...
        <div class="banner__info">
            ...
            <h2 class="banner__info--text">THE NEW GLOBAL CONTEXT</h2>
            <button id="button--register">Đăng ký dự thi</button>
        </div>
        <a class="banner__btn-scroll-down" href="#intro">
